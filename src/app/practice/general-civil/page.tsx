  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <DefectFaq 
          title="일반 민사 자주 묻는 질문"
          subtitle="* 여러분의 민사적 고민과 법률적 우려를 명쾌하게 해결해 드립니다."
          items={[
            {
              id: 1,
              question: '빌려준 대여금인데 증여금이라며 반환을 거부합니다. 차용증 없어도 돌려받을 수 있나요?',
              answer: '차용증이 없더라도 금전이 오고 간 내역과 당시 대여임을 추단할 수 있는 문자 메시지, 녹취, 이자 입금 내역 등을 통해 대여 사실을 입증할 수 있습니다. 재판부는 당사자 간의 관계, 금원 교부의 경위 등을 종합적으로 고려하여 대여인지 증여인지를 판단하므로, 객관적인 정황 증거를 얼마나 확보하느냐가 관건이라 하겠습니다.'
            },
            {
              id: 2,
              question: '물건은 보냈는데 대금 지급을 미룹니다. 소송이 답일까요?',
              answer: '소송은 최후의 수단이며, 우선 내용증명을 통해 지급을 독촉하고 이행하지 않을 경우 법적 조치를 예고하는 것이 보다 효과적일 수 있습니다. 채무자의 인적 사항이 명확하고 다툼의 여지가 적다면 소송보다 빠르고 저렴한 \'지급명령\' 신청을 고려해 볼 수 있으며, 그럼에도 해결되지 않는다면 민사 소송을 통해 집행권원을 확보해야 합니다.'
            },
            {
              id: 3,
              question: '납품받은 물건에 하자가 있어 결제를 안한 건데 상대가 내용증명 발송했습니다. 대처 방법 있을까요?',
              answer: '물건의 하자로 인해 계약의 목적을 달성할 수 없다면 \'동시이행의 항변권\'을 행사하여 대금 지급을 거절하거나 하자보수 및 손해배상을 청구할 수 있습니다. 상대방의 내용증명에 대해서는 하자의 구체적인 내용과 증거 등을 바탕으로 지급 거절의 정당한 사유를 밝히는 답변서를 발송함으로써 차후 법적 분쟁에서 방어 논리를 선제적으로 구축해야 합니다.'
            },
            {
              id: 4,
              question: '본사로부터 갑작스러운 계약 종료 통보를 받았습니다. 가맹점을 계속 운영할 방법이 없을까요?',
              answer: '가맹사업법상 본사가 계약을 해지하려면 2개월 이상의 유예기간을 두고 2회 이상 서면으로 통지하는 등 적법한 절차를 준수해야 합니다. 부당한 해지 통보라면 \'가맹점주 지위 보전 가압류\' 등 가처분 신청을 통해 법원의 최종 판단이 나올 때까지 운영을 계속할 수 있으며, 본사의 위법 행위 여부를 검토하여 계약 유지 또는 손해배상을 청구할 수 있습니다.'
            },
            {
              id: 5,
              question: '허위사실을 유포하여 저의 명예를 훼손했습니다. 손해배상청구 가능할까요?',
              answer: '허위 사실 유포로 인해 사회적 평가가 저하되고 정신적·경제적 피해를 입었다면 민법상 불법행위에 기한 손해배상(위자료) 청구가 가능합니다. 다만, 유포된 내용이 \'허위\'임을 입증해야 하고 그로 인해 실제 발생한 손해와의 인과관계를 증명해야 하므로 객관적인 자료 확보가 선행되어야 합니다.'
            },
            {
              id: 6,
              question: '오래된 채권인데 지금이라도 청구할 수 있나요? 시효가 끝났을까 봐 불안합니다.',
              answer: '일반 민사채권의 소멸시효는 10년이지만, 상행위로 인한 채권은 5년, 공사대금이나 물품대금 등은 3년으로 짧은 경우가 많습니다. 만약 시효가 임박했다면 재판상 청구, 압류, 가압류 또는 채무자의 채무 승인(일부 변제 등)을 통해 시효를 중단시켜야 하므로 신속한 대응을 권장합니다.'
            }
          ]}
        />
