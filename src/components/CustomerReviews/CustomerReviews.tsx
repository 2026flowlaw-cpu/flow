    ...
    <section id="reviews" className={styles.section}>
      <div className="container">
        <div className={styles.header}>
          <span className={styles.kicker}>TRUSTED VOICES</span>
            ...
            <div key={review.id} className={styles.card}>
              <div className={styles.quoteIcon}>
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 11L8 17H5L7 11V7H11V11H10ZM18 11L16 17H13L15 11V7H19V11H18Z" fill="#C5A059" fillOpacity="0.2"/>
                </svg>
              </div>
              
              <div className={styles.avatarWrapper}>
                <div className={styles.avatarRing} style={{ borderColor: review.avatarColor }}>
