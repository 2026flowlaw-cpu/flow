            ...
            <div className={styles.heroContentGrid}>
              <div className={styles.heroLeft}>
                ...
                <div className={styles.heroSubtitles}>
                  <span className={styles.titleSub1}>{data.subtitle}</span>
                  <span className={styles.titleSub2}>형사사건의 처음과 끝, 법무법인 플로우가 함께합니다.</span>
                </div>
                <p className={styles.heroDescription}>
                  {data.desc} <br />
                  법무법인 플로우는 각 분야의 전문성 있는 형사 전담 센터를 통해 의뢰인의 권익을 가장 확실하게 보호하는 법률 솔루션을 제공합니다.
                </p>
              </div>
            </div>
          </div>
